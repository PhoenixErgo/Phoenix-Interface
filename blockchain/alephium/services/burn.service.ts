...
export const burn = async (signerProvider: SignerProvider, bankContractId: string, amountHodlTokenToBurn: bigint, interfaceFee: bigint): Promise<ExecuteScriptResult> => {

...
class Factory extends ContractFactory<PhoenixBankInstance, PhoenixBankTypes.Fields> {
  ...
  tests = {
    getSymbol: async (
      params: Omit<TestContractParams<PhoenixBankTypes.Fields, never>, 'testArgs'>
    ...
    mint: async (
      params: TestContractParams<PhoenixBankTypes.Fields, { amountHodlTokenDesired: bigint }>
    ): Promise<TestContractResult<null>> => {
      return testMethod(this, 'mint', params);
    },
    burn: async (
      params: TestContractParams<PhoenixBankTypes.Fields, { amountHodlTokenToBurn: bigint }>
    ): Promise<TestContractResult<null>> => {
      return testMethod(this, 'burn', params);
    },
    deposit: async (
      params: TestContractParams<PhoenixBankTypes.Fields, { amountTokenToDeposit: bigint }>
    ): Promise<TestContractResult<null>> => {
      return testMethod(this, 'deposit', params);
    },
    payDevs: async (
      params: TestContractParams<PhoenixBankTypes.Fields, { amountToDistribute: bigint }>
    ): Promise<TestContractResult<null>> => {
      return testMethod(this, 'payDevs', params);
    },
    divUp: async (
      params: TestContractParams<PhoenixBankTypes.Fields, { dividend: bigint; divisor: bigint }>
    ): Promise<TestContractResult<bigint>> => {
...
export class PhoenixBankInstance extends ContractInstance {
  ...
  subscribeMintEvent(
    ...
    return subscribeContractEvent(PhoenixBank.contract, this, options, 'Mint', fromCount);
  }
  ...
  subscribeBurnEvent(
    ...
    return subscribeContractEvent(PhoenixBank.contract, this, options, 'Burn', fromCount);
  }
  ...
  subscribeDepositEvent(
    ...
    return subscribeContractEvent(PhoenixBank.contract, this, options, 'Deposit', fromCount);
  }

  subscribeAllEvents(
    options: EventSubscribeOptions<
      PhoenixBankTypes.MintEvent | PhoenixBankTypes.BurnEvent | PhoenixBankTypes.DepositEvent
    >,
    fromCount?: number
  ): EventSubscription {
    return subscribeContractEvents(PhoenixBank.contract, this, options, fromCount);
  }

...
import { toaster_copy_text, txSubmitted } from '../Notifications/Toast';
  ...
  return (
    ...
    >
      <div style={{ fontFamily: `'Space Grotesk', sans-serif` }}>
        <p className="text-black">Complete the action with an ErgoPay compatible wallet.</p>
        ...
        <div className="flex justify-center">
          ...
          >
            {<QRCode size={150} value={ergoPayLink} />}
          </div>
        </div>
        <div>
        ...
        <div className="flex justify-center mt-4">
          <CopyToClipboard text={textToCopy} onCopy={(e) => handleCopyText(e)}>
            <Button block style={{ fontFamily: `'Space Grotesk', sans-serif` }} className="mr-2">
              Copy request
            </Button>
          </CopyToClipboard>

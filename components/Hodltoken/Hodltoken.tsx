...
import { addressFromContractId, ALPH_TOKEN_ID, contractIdFromAddress, hexToString, NodeProvider } from "@alephium/web3";
...
const tokenData = [
    {
        id: 1001, baseToken: "COMET", title: "hodlCOMET", bankFee: 3, gameData: {
            currentPrice: 1,
            circulatingSupply: 1,
            tvl: 1,
        }
    ...
    {
        id: 1002, baseToken: "SigUSD", title: "hodlSigUSD", bankFee: 4, gameData: {
            currentPrice: 1,
            circulatingSupply: 1,
            tvl: 1,
        }
    ...
    {
        id: 1003, baseToken: "SigUSD", title: "hodlSigUSD", bankFee: 14, gameData: {
            currentPrice: 1,
            circulatingSupply: 1,
            tvl: 1,
        }
    ...
    {
        id: 1004, baseToken: "SPF", title: "hodlSPF", bankFee: 2, gameData: {
            currentPrice: 1,
            circulatingSupply: 1,
            tvl: 1,
        }
    ...
    {
        id: 1005, baseToken: "SPF", title: "hodlSPF", bankFee: 20, gameData: {
            currentPrice: 1,
            circulatingSupply: 1,
            tvl: 1,
        }
    ...
    {
        id: 1006, baseToken: "SPF", title: "hodlSPF", bankFee: 7, gameData: {
            currentPrice: 1,
            circulatingSupply: 1,
            tvl: 1,
        }
    ...
    {
        id: 1007, baseToken: "SPF", title: "hodlSPF", bankFee: 10, gameData: {
            currentPrice: 1,
            circulatingSupply: 1,
            tvl: 1,
        }
    ...
    useEffect(() => {
        ...
        switch (network) {
            ...
            case '6': {
                ...
                nodeProvider.events.getEventsContractContractaddress(
                    getFactoryConfig(network).factoryAddress,
                    {
                        start: 0,
                        limit: 100,
                    }
                    ...
                    const tokensPromises = events.events.map(async (event, index) => {
                        ...
                        const baseTokenMetadata = await nodeProvider.fetchFungibleTokenMetaData(baseTokenId as string);
                        ...
                        const hodlBankContract = new HodlBankContract(addressFromContractId(contractId), network);

                        const currentPrice = await hodlBankContract.mintAmount(BigInt(10) ** BigInt(hodlTokenDecimals));
                        ...
                        return {
                            ...
                            gameData: {
                                ...
                                circulatingSupply: formatBigIntWithDecimalsRounded(circulatingSupply, hodlTokenDecimals, 4),
    ...
    return (
        <div className="flex flex-col items-center">
            ...
            {tokensList.length === 0 ? loading :
                <>
                    {tokensList.map(({ id, baseToken, title, bankFee, gameData, contractId, baseTokenId, decimals }) => (
                        <div key={id} className="max-w-l mx-auto font-inter my-10 mx-20">
                            <div className="bg-gray-200 shadow-lg flex content-between rounded-md w-[350px] lg:w-[800px]  flex-col lg:flex-row p-2">
                                ...
                                <div className="container mx-auto border lg:border-l-gray-300 flex flex-col items-center justify-around">
                                    <MintingHodlAlph network={network} percent={bankFee.toString()} baseTokenTicker={baseToken} baseTokenId={baseTokenId} contractId={contractId} decimals={decimals} />
                                    <BurningHodlAlph network={network} percent={bankFee.toString()} baseTokenTicker={baseToken} baseTokenId={baseTokenId} contractId={contractId} decimals={decimals} />

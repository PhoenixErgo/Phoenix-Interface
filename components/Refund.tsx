...
import { noti_option, noti_option_close, txSubmitted } from '@/components/Notifications/Toast';
...
const Refund = (props: IProps) => {
  ...
  const handleClick = async () => {
    ...
    const transactionInfo: TransactionInfo | ErgoTransaction = await getUnConfirmedOrConfirmedTx(
      txId,
      isMainnet
    );
    ...
    const feeBoxes =
      'blockId' in transactionInfo
        ? //@ts-ignore
          (transactionInfo as TransactionInfo).outputs.filter(
            (o) =>
              o.ergoTree ===
              '1005040004000e36100204a00b08cd0279be667ef9dcbbac55a06295ce870b07029bfcdb2dce28d959f2815b16f81798ea02d192a39a8cc7a701730073011001020402d19683030193a38cc7b2a57300000193c2b2a57301007473027303830108cdeeac93b1a57304'
          )
        : (transactionInfo as ErgoTransaction).outputs.filter(
            (o) =>
              o.ergoTree ===
              '1005040004000e36100204a00b08cd0279be667ef9dcbbac55a06295ce870b07029bfcdb2dce28d959f2815b16f81798ea02d192a39a8cc7a701730073011001020402d19683030193a38cc7b2a57300000193c2b2a57301007473027303830108cdeeac93b1a57304'
          );
    ...
    //@ts-ignore
    const totalFeePaid: bigint = feeBoxes.reduce(
      (acc: bigint, curr: any) => acc + BigInt(curr.value),
      BigInt(0)
    );
    ...
    <>
      <div className="flex items-center justify-center py-8 lg:py-12 min-h-[70vh] font-inter">
        <div className="max-w-md mx-auto">
          ...
          <div className="my-3">
            <label htmlFor="Proxy-address" className="text-black text-base font-medium">
              Proxy address
            </label>
            <input
